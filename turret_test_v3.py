...
def calculate_max_radius(vertices, centroid):
    """Calculate the maximum radius of the circle that can fit within the triangle."""
    distances = [
...
def update_plot(angle_deg, leg_length):
    ...
    max_radius = calculate_max_radius(vertices, centroid)
